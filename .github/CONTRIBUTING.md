...
5. For large features or changes, please [open an issue](https://github.com/eriocnemis/m2.framework.Exception/issues) and discuss first. This may prevent duplicate or unnecessary effort, and it may gain you some additional contributors.
...
1. Search current [listed issues](https://github.com/eriocnemis/m2.framework.Exception/issues) (open or closed) for similar proposals of intended contribution before starting work on a new contribution.
...
The [full text is available](https://github.com/eriocnemis/m2.framework.Exception/blob/master/.github/CODE_OF_CONDUCT.md) in the repository.
